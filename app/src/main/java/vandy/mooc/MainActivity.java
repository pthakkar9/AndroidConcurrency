...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    public void downloadImage(View view) {
        try {
            ...
            // @@ DoneTODO - you fill in here.
            Uri imageUrl = getUrl();
            Intent dImageIntent = null;

            if (imageUrl != null) {
                dImageIntent = makeDownloadImageIntent(imageUrl);
            }
            ...
            // I could have combined these two steps inside one if condition
            // but I decided to address both of them separately to increase
            // readability of the code
            if (dImageIntent != null) {
                startActivityForResult(dImageIntent, DOWNLOAD_IMAGE_REQUEST);
            }
    ...
    protected void onActivityResult(int requestCode,
        ...
        // @@ DoneTODO -- you fill in here, replacing true with the right
        // code.
        if (resultCode == RESULT_OK) {
            // Check if the request code is what we're expecting.
            // @@ DoneTODO -- you fill in here, replacing true with the
            // right code.
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                // @@ DoneTODO -- you fill in here.
                Intent startGalleryIntent = makeGalleryIntent(data.getDataString());

                // Start the Gallery Activity.
                // @@ DoneTODO -- you fill in here.
                startActivity(startGalleryIntent);
            }
        }
        ...
        // code.
            ...
            Toast.makeText(this, "Couldn't download image at given URL. Please try again.",
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        // the image.
        // DoneTODO -- you fill in here, replacing "null" with the proper
        // code.
    ...
    private Intent makeDownloadImageIntent(Uri url) {
        ...
        // I could have created a string variable that holds chooser text i.e. Open url with:, but
        // decided not to change anything else other than where asked
    ...
    protected Uri getUrl() {
        ...
        // As described in assignment 1 walkthru, it's not the handling case
        // where valid URL is not an image.
        // It just verifies whether it's valid URL or not.
        // Don't forget to put 'http' or 'https' for testing
